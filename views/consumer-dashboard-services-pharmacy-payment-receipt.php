    ...
    <div class="consumer-pharmacy-neworders-advanceinfo__order-med-details">
        ...
        <div class="consumer-pharmacy-neworders-advanceinfo__order-med-details__description">
            ...
            <div class="consumer-pharmacy-neworders-advanceinfo__order-med-details__description__Note">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, amet asperiores at atque distinctio ea hic id  tenetur unde voluptates.</p>
            </div>
        </div>
    </div>
    <div class="consumer-pharmacy-neworders-advanceinfo__button">
        <button class="advance-info-submit-button" id="advance-info-submit-button"><a href="/consumer-dashboard-product-payment">Continue to Pay</a></button>
    </div>
</div>
