    ...
    foreach ($medicines as $medicine) {
        ...
        echo "
                    ...
                    <td id='action-block'>
                        ...
                        <button id = 'update-medicines-$med_id'  data-medicineid = '$med_id' data-medicinename = '$med_name' class='action-btn action-btn--update medicine-update'><i class='fa-solid fa-pen' style='color: #FFB200
'></i></button>
