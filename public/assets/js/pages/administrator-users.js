...
//             <form class="user-update-form" action="/admin-dashboard/consumers/update?userName=${userName}" method="post">
//                <input type="hidden" name="consumer_nic" id="consumer_nic" value="${userId}">
...
//                     <button class="ok-btn" id="update-ok-btn" formaction="/admin-dashboard/consumers/update?userName=${userName}">Ok</button>
//                 </div>
//             </form>
//         </div>
//         `;
//
//         document.getElementById("consumer_nic").value = userId;
//
